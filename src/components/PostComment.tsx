...
const PostComment: FC<PostCommentProps> = ({
    ...
    return (
        <div ref={commentRef} className='flex flex-col'>
            ...
            <p className='text-sm text-zinc-900 dark:text-gray-100 mt-2'>{comment.text}</p>
                    ...
                    <div className='grid w-full gap-1.5'>
                        ...
                        <div className='mt-2'>
                            ...
                            <div className='mt-2 flex justify-end gap-2'>
                                ...
                                <Button isLoading={isLoading} disabled={input.length === 0} onClick={() => postComment({postId, text: input, replyToId: comment.replyToId ?? comment.id})}>
                                    Post
                                </Button>
                            </div>
                        </div>
