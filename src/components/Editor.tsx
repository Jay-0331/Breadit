...
const Editor: FC<EditorProps> = ({ subredditId }) => {
    ...
    return <div className='w-full p-4 bg-zinc-100 dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800'>
        <form id='subreddit-post-form' className='w-full' onSubmit={handleSubmit(onSubmit)}>
            <div className='prose prose-stone dark:prose-invert'>
                <TextareaAutosize
                    ...
                    {...rest}
                    placeholder='Title' 
                    className='w-full resize-none appearance-none overflow-hidden bg-transparent text-2xl sm:text-3xl font-bold focus:outline-none'
                />
